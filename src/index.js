...
export default class App extends Component {
  ...
  inicia() {
    initialize().catch(() =>
      console.log('Falha ao inicializar o botão flutuante'),
    );
  }

  adiciona() {
    showFloatingBubble(350, 300).catch(() =>
      console.log('Failed to Floating Bubble Added'),
    );
  }

  remove() {
    hideFloatingBubble().catch(() => console.log('Failed to Removed Bubble'));
  }
